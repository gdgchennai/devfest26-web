...
export type SubEvent = {
   ...
   *  next/image exactly like every other image on the site (resized
   *  by Cloudflare Images in production, see next.config.ts). Omitted while the event has no real photography yet —

...
export function SignInPanel() {
  ...
  return (
    <div className="flex flex-col items-center gap-6 w-full max-w-sm">
      {error && (
        <div className="w-full rounded-2xl border border-red/30 bg-red/10 p-4 text-center text-xs text-red animate-fade-in shadow-sm flex items-start gap-3">
          <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 mt-0.5 text-red">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
          </svg>
          <div className="text-left font-sans text-paper/90">
            <p className="font-bold text-[13px] text-red-pastel">Sign-In Failed</p>

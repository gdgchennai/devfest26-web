  ...
  return (
    <form action={action} className="flex flex-col gap-2 sm:flex-row sm:items-center">
      ...
      <input
        ...
        className="w-full rounded-full border border-paper/15 bg-transparent px-4 py-2 text-sm text-paper placeholder:text-paper/40 focus:border-paper/40 focus:outline-none sm:w-64"
      />
